...
var messages = window["messages"] = {
  ...
  'strings': {
    ...
    'titleDefaultLang': {
        ...
        localText: 'Predvolený jazyk'
      },
      'titleGeneral': {
      defaultText: 'General Settings',
      localText: 'Všeobecné nastavenia'
    },
    'titleEnableAutoPrompt': {
      ...
      'titleEnableAutoTranslation': {
        ...
        localText: 'Automaticky preložiť webové stránky po zobrazení výzvy'
      },
      'manualTranslationNote': {
        defaultText: 'Selecting "No" adds a clickable manual button to your browser for translatable web pages',
        localText: 'Voľba "Nie" dodáva klikacie tlačidlo príručky, vo Vašom prehliadači pre preklad, webové stránky'
      },
      'titleEnableSecureTranslation': {
      defaultText: 'Enable translation on secure pages',
      localText: 'Povoliť preklad na zabezpečených stránkach'
    },
    'titleLanguageSettings': {
      defaultText: 'Change your settings per language',
      localText: 'Zmeňte nastavenia pre každý jazyk'
    },
    'clearPreferences': {
    ...
    'blanketPreferences': {
      ...
      localText: 'Preložiť zo všetkých jazykov'
    },
    ...
    'translateAlwaysOption': {
      ...
      localText: 'Vždy prekladať z tohto jazyka'
    },
